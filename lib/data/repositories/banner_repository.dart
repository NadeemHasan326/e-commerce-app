...
import 'package:e_commerce_app/core/exceptions/firebase_exceptions.dart';
import 'package:e_commerce_app/core/exceptions/format_exceptions.dart';
import 'package:e_commerce_app/core/exceptions/platform_exceptions.dart';
import 'package:e_commerce_app/data/models/banner_model.dart';
import 'package:e_commerce_app/data/services/firebase_storage_services.dart';
  ...
  Future<void> uploadDummyBanners(List<BannerModel> banners) async {
    try {
      ...
      for (var banner in banners) {
        ...
        final imageFile = await HkFirebaseStorageService()
            .getImageDataFromAssets(banner.imageUrl);

        // Upload banner to Firebase Storage
        final imageUrl = await HkFirebaseStorageService().uploadImageData(
          'Banners/',
          imageFile,
