...
import 'package:e_commerce_app/screens/widgets/terms_conditions_checkbox.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:iconsax/iconsax.dart';

class HkSignUpForm extends StatelessWidget {
  const HkSignUpForm({super.key});
    ...
    return Form(
      ...
      child: Column(
        children: [
          ...
          TextFormField(
            validator: (value) =>
                HkValidator.validateEmptyText('Username', value),
            controller: controller.username,
            decoration: const InputDecoration(
              labelText: HkTexts.username,
